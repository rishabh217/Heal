...
import static com.app.heal.utils.HelperKt.dp2px;
import static com.app.heal.utils.HelperKt.sp2px;
...
public class ArcProgress extends View {
    ...
    private final int default_unfinished_color = Color.rgb(244,143,177);
    private final int default_text_color = Color.rgb(250,175,201);
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_suffix_padding = dp2px(getResources(), 15);
        default_suffix_text = "%";
