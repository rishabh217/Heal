...
class PrescriptionNotUploadedFragment : BaseFragment(), FirstDoctorIdCallback {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_prescription_not_uploaded, container, false)
